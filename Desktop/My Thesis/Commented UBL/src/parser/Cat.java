...
public abstract class Cat {
	...
	static public Cat makeCat(String cat){
		String c = cat.trim();
		//System.out.println("i am in makecat of cat.java");
		int colon = c.indexOf(':'); 
		
		//< everything after the colon is semantics
		Exp e = null;
		if (colon != -1){
            System.out.println("I am sending this to makeexp.java of Exp.java from cat.java"+c.substring(colon+1,c.length()));
