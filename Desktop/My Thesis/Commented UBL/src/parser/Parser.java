...
public class Parser {
	...
	public Parser(){
        System.out.println("I am in parser constructor");
    ...
    public void makeFeatures(){
    	...
    	int fStartIndex =0;
        System.out.println("I am in make features");
	...
	public static List tokenize(String input){
		...
		while (st.hasMoreTokens()){
            System.out.println("i am being tokenized");
	...
	public Chart parse(String input, Exp pruningSem, boolean computeInside){
        ...
        System.out.println("kal made to chart.java with tokens as input");
		// create a chart and add the input words
        System.out.println("tokens fed to chart.java");
