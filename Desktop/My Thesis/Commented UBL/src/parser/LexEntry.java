...
public class LexEntry {
     ...
     **/
    public LexEntry(String t, String c){
        System.out.println("i am in lex entry.java");
       // System.out.println("I am having a problem with "+c+"in lexentry.java");
	...
	while (st.hasMoreTokens()){
        ...
        System.out.println("kal to makecat in cat.java from lexentry.java");
	myCat = Cat.makeCat(c);
