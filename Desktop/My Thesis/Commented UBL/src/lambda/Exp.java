...
public abstract class Exp {
	...
	static public Exp makeExp(String input){
        System.out.println("I am in makeexp() of Exp.java");
	...
	static public Exp makeExp(String input, Map vars){
        ...
        if (input.startsWith("(")){
			...
			String p = lr.next();
            System.out.println("I am in second input starts with function");
			if (Lang.hasPred(p))
		...
		if (input.startsWith("(")){
			// detemine if it is a function application or a literal
			LispReader lr = new LispReader(new StringReader(input));
            System.out.println("I am checking"+input+"in exp.java");
			String p = lr.next();
            System.out.println("The function being updated is "+lr.next());
