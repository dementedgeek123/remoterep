 ...
 *  entities. This should be loaded uunknow *  The type heirarchy should be stored in a file with one type
...
public class PType extends Type {
	...
	public PType(String input){
        //system.out.println("My unknown input ")
		setVals(input);
		int i = types.indexOf(this);
        System.out.println("i am adding ptypes in Ptype");
        System.out.println("The index of "+types+"is "+i);
		if (i==-1){
	...
	static public void addTypesFromFile(String filename){
		...
		try{
			...
			while (line!=null){  // for each line in the file
				...
				line = in.readLine();
                System.out.println("In Ptype.java the read line is"+line);
			}
