...
public class DevTrain extends Train {
	...
	public static void main(String[] args){
		...
		System.out.println("Train Size: "+train.size()+"Train being fed");
        ...
        System.out.println("W-c giza probs being fed and callling load coocccounts");
		LexiconFeatSet.loadCoOccCounts(giza_probs);

		String fixedlex = "none";
		fixedlex = language+"-np-fixedlex.geo";
       // System.out.println("The fixed lex is "+fixedlex);

		Lexicon fixed = new Lexicon();
        //System.out.println("My Lex is "+fixed.getLexEntries());
        ...
        System.out.println("kal made to makefeatures in devtrain");
		p.makeFeatures();
		Train t = new Train();
        System.out.println("Kal to setting setdataset");
		t.setDataSet(train);
        System.out.println("Kal to setting traindataset");
		t.setTestSet(test);
